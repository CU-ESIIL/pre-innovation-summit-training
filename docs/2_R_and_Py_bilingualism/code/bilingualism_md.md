...
<img src="bilingualism_md_files/figure-gfm/unnamed-chunk-57-1.png" width="672" />
...
```
    ...
    ## Residuals:
    ##      Min       1Q   Median       3Q 
    ## -0.89239 -0.40121  0.06764  0.31847 
    ##      Max 
    ##  0.98637 
    ## 
    ## Coefficients:
    ##             Estimate Std. Error
    ## (Intercept)  0.51606    0.43008
    ## x            0.89408    0.06931
    ##             t value Pr(>|t|)    
    ## (Intercept)     1.2    0.265    
    ## x              12.9 1.23e-06 ***
    ...
    ##   '.' 0.1 ' ' 1
    ## 
    ## Residual standard error: 0.6296 on 8 degrees of freedom
    ## Multiple R-squared:  0.9541, Adjusted R-squared:  0.9484 
    ## F-statistic: 166.4 on 1 and 8 DF,  p-value: 1.234e-06
...
<img src="bilingualism_md_files/figure-gfm/unnamed-chunk-59-1.png" width="672" />
